...
jtabChord.prototype.parseCustomChordArrayFromToken = function() {
    ...
    fingeredFrets = jQuery
        .grep(array, function(pair) {
...
Raphael.fn.debug_grid = function(width) {
    ...
    this.path(
        this.svg_params(
            this.current_offset + width - this.margin_right,
            0,
            0,
            2
        )
...
Raphael.fn.chord_fretboard = function(position, chord_name) {
    ...
    for (var i = 0; i <= this.frets_drawn; i++) {
        ...
        pos =
            fret_labels[position + i] === undefined
                ? ''
                : fret_labels[position + i];
...
jtab.characterize = function(notation) {
    ...
    if (gotChord && gotTab) {
        ...
        Raphael.fn.tab_top =
            Raphael.fn.chord_height + Raphael.fn.tab_margin_top;
        Raphael.fn.total_height =
            Raphael.fn.tab_top +
            Raphael.fn.tab_height +
            Raphael.fn.margin_bottom;
    } else if (gotChord) {
        // chord only
        tabtype = 2;
        Raphael.fn.has_chord = true;
